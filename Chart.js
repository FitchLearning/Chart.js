...
(function(){
    ...
    var Chart = function(context, chartIdName){
        var chart = this;

        root.Chart.chartId = chartIdName;
    ...
    Chart.defaults = {
        global: {
            ...
            // Function - Will fire just before a tool tip is drawn.
            onToolTipRedraw: function(){}
    ...
    /**
     *
     * @type {{Bar, Doughnut, Line, PolarArea, Radar, Spie, Fitch}}
     */
    Chart.types = {};
    ...
    // Gets the angle from vertical upright to the point about a centre.
        ...
        getFirstCanvasInstance = helpers.getFirstCanvasInstance = function() {
            return root.Chart.instances[Object.keys(root.Chart.instances)[0]].chart.canvas;
        },
    ...
    //-- DOM methods
        getRelativePosition = helpers.getRelativePosition = function(evt){
            ...
            var container = document.getElementById(root.Chart.chartId).parentNode;
